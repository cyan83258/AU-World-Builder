...
(function (A) {
    ...
    /* ══════════════════════════════════════════════
       ...
       ══════════════════════════════════════════════ */
    function hasAny(p) {
        return !!(p.world || p.charSetting || p.userSetting);
    }
    ...
    A.buildGuidelines = function () {
        ...
        g.push(opts.original === 'break'
            ? '- BREAK FROM ORIGINAL: Completely reimagine characters.'
            : '- REFLECT ORIGINAL: Preserve core traits.');
    ...
    A.buildOutputFormat = function (filterIds) {
        ...
        return sections.map(function (sec) {
            ...
            switch (sec.id) {
                case 'world':
                    desc = '(' + worldP + ' paragraphs: world rules & core mechanics / atmosphere, social dynamics & daily life / key locations & sensory details)';
                    break;
                case 'charSetting':
                    desc = '(' + charP + ' paragraphs about ' + ci.charName + ': public role & reputation / private self, contradictions & habits / goals, fears & hidden depths)';
                    break;
                case 'userSetting':
                    desc = '(' + charP + ' paragraphs about ' + ci.userName + ': independent role & personality / dynamic with ' + ci.charName + ' & personal stakes)';
                    break;
                case 'charClothing':

...
(function (A) {
    ...
    A.buildGuidelines = function () {
        ...
        /* Quality hints — condensed */
        g.push('- QUALITY: Write vivid, sensory prose with narrative voice. Characters need contradictions and hidden motivations. Each section must contain at least one surprising hook or hidden connection.');
        g.push('- ORIGINALITY: Reject generic ideas, clichés, and Wikipedia-tone summaries. If an idea feels predictable, twist it. All sections must feel interconnected.');
        ...
        return sections.map(function (sec) {
            ...
            switch (sec.id) {
                ...
                case 'charPersonality':
                    desc = '(' + charP + 'P: ' + ci.charName + ' — personality, inner conflicts, quirks)';
                    break;
                case 'userSetting':
                ...
                case 'charRelation':
                    ...
                    break;
                case 'charHistory':
                    desc = '(' + charP + 'P: shared past of ' + ci.charName + ' & ' + ci.userName + ')';
                    break;
                case 'charClothing':

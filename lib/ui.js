...
(function (A) {
    ...
    function initSourceDetail() {
        ...
        /* Restore aspect checkboxes */
        var aspects = opts.sourceDetailAspects || {};
        panel.querySelectorAll('input[data-aspect]').forEach(function (cb) {
            var key = cb.getAttribute('data-aspect');
        ...
        /* Aspect checkbox changes */
        panel.addEventListener('change', function (e) {
            var cb = e.target.closest('input[data-aspect]');
            if (!cb) return;
            var s = A.getSettings();
            if (!s.genOptions) s.genOptions = {};
            if (!s.genOptions.sourceDetailAspects) s.genOptions.sourceDetailAspects = {};
            s.genOptions.sourceDetailAspects[cb.getAttribute('data-aspect')] = cb.checked;
            A.saveSetting('genOptions', s.genOptions);
        });
    }

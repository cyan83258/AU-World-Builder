...
(function (A) {
    ...
    A.DEFAULT_INITIAL_PROMPT = [
        ...
        '',
        '## QUALITY STANDARDS',
        '- Every section must read like polished creative writing, not a wiki summary or textbook entry.',
        ...
        '- REJECT the first obvious idea. If a concept, trait, or relationship dynamic feels like it could appear in any random story, discard it and dig deeper.',
        '- DO NOT produce encyclopedia-style enumerations or laundry lists of attributes. Write with narrative voice and rhythm.',
        '',
        '{{VOLUME_INSTRUCTION}}',
        '',
        '## AU Concept',
